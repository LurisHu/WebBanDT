...
<form:form modelAttribute="nd">
	...
	<div class="form-group">
		<button class="btn btn-primary" formaction="/admin/nguoidung/admin/create">Create</button>
		<button class="btn btn-warning" formaction="/admin/nguoidung/admin/update">Update</button>
		<button class="btn btn-danger" formaction="/admin/nguoidung/admin/delete">Delete</button>
