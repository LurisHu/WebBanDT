...
<div class="Categories">
	<div class="path">
		<a href="/customer/sanpham/index">Trang chủ</a>&nbsp;/&nbsp;<a href="/customer/danhmuc/phukien/0">Phụ kiện</a>
	</div>
	<div class="banner">
	...
	<div class="clear-fix">
		...
		<div>
				<ul class="pager">
					<li><a href="/customer/danhmuc/phukien/0">First</a></li>
					<li><a href="/customer/danhmuc/phukien/${pageNo-1}">Previous</a></li>
					<li><a href="/customer/danhmuc/phukien/${pageNo+1}">Next</a></li>
					<li><a href="/customer/danhmuc/phukien/${lastPageNo}">Last</a></li>
				</ul>
			</div>
	</div>
</div>