	...
	<div class="product">
		<div class="col-sm-12">
			<strong>Điện thoại bán chạy nhất</strong> <a id="link" href="#"
				type="button" class="btn btn-link">Iphone</a> <a id="link" href="#"
				type="button" class="btn btn-link">Samsung</a> <a id="link" href="#"
				type="button" class="btn btn-link">Oppo</a> <a id="link" href="#"
				type="button" class="btn btn-link">Vivo</a>
		</div>
				...
				<div class="col-sm-4 panel-group" style="cursor: pointer;">
					<div class="panel">
						...
						<div class="panel-body">
							...
							<div class="col-sm-5">
								<a href="/customer/sanpham/detail/${p.maSP}"> <img id="img3"
		...
		<div class="col-sm-12">
			<strong>Phụ kiện bán chạy nhất</strong> <a id="link" href="#"
				type="button" class="btn btn-link">Samsung</a> <a id="link" href="#"
				type="button" class="btn btn-link">JBL</a> <a id="link" href="#"
				type="button" class="btn btn-link">Sony</a> <a id="link" href="#"
				type="button" class="btn btn-link">Iphone</a>
		</div>
		<div class="showproduct">
