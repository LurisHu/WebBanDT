	...
	<div class="bill-container">
		<div class="panel bill-panel">
			...
			<div class="panel-body">
				...
				<div class="panel-default">
					...
					<div class="panel-body body-mini">
						...
						<p>
							*Tổng tiền:&ensp;<span><fmt:formatNumber value="${sessionScope['scopedTarget.cartService'].amount}" /><sup>đ</sup></span>
						</p>
					</div>
				...
				<div class="purchased">
					<div class="panel-default">
						...
						<div class="panel-footer footer-mini">
							<p>Chúng tôi sẽ giao hàng sớm nhất cho quý khách. Đảm bảo
								hàng mà quý khách nhận được là mới 100% và còn nguyên vẹn khi
								đến tay quý khách.</p>
						</div>
					</div>
				</div>
			...
			<div class="panel-footer">
				<p>
					<span>Lưu ý:</span>&nbsp; Nếu có sơ xuất trong lúc giao hàng xin
					quý khách hãy báo lại với chúng tôi để được đổi mới sản phẩm.
				</p>
				<div class="bill-back">
